/**
 * Single-file client + ESM host build for dsh-local-history.
 *
 * The web server serves exactly one file per plugin (/plugins/dsh-local-history/client.js),
...
await build({
  ...
  banner: {
    js: "window.__ModuleLoader__.load({ id: 'dsh-local-history', factory: (require) => { var module = { exports: {} }; var exports = module.exports;",
  },
  footer: {
