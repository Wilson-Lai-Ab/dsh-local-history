...
${path}`;
        ...
        if (existing === void 0) {
          order.push(key);
          const hit = { path, kind: location.kind, turn, oldText };
          if (hunks.length > 0) hit.diffs = hunks;
          byKey.set(key, hit);
        } else {
          existing.kind = location.kind;
          if (existing.oldText === void 0 && oldText !== void 0) existing.oldText = oldText;
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
                      "button",
                      {
                        ...
                        children: [
                          ...
                          shown.location !== null && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dsh_lh_location", children: t("ofLocation", { path: shown.location }) }),
...
function DiffView(props) {
  ...
  const [accepted, setAccepted] = (0, import_react4.useState)(() => acceptedHunkKeys(record));
  const revertRef = (0, import_react4.useRef)(() => false);
  const liveRef = (0, import_react4.useRef)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh_lh_root dsh_lh_pane", "data-lh-diff": "", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh_lh_reviewBar", children: [
    ...
    state.binary ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh_lh_empty", children: t("binaryFile") }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh_lh_file", children: blocks.map((block, blockIndex) => {
...
function SplitDiffView(props) {
  ...
  const leftRef = (0, import_react5.useRef)(null);
  const rightRef = (0, import_react5.useRef)(null);
  const syncingRef = (0, import_react5.useRef)(false);
  ...
  const highlighted = (0, import_react5.useMemo)(() => splitHighlighted(rows), [rows]);
...
function ReviewTab(props) {
  ...
  if (remote === void 0) {
    return (0, import_react6.createElement)("div", { className: "dsh_lh_error" }, t("loadFailed"));
  }
  return (0, import_react6.createElement)(ReviewApp, {
    scope: props.scope,
  ...
  ctx.inject(["betterSidebar"], (scope) => {
    ...
    ctx.effect(() => sidebar.registerTab({
      ...
      settings: {
        ...
        render: () => {
          ...
          if (remote === void 0) return (0, import_react6.createElement)("div", { className: "dsh_lh_error" }, t("loadFailed"));
          return (0, import_react6.createElement)(SettingsPanel, { remote, t });
        }
      },
      component: (props) => (0, import_react6.createElement)(ReviewTab, {
        ctx,
        sidebar,
        scope: props.scope,
        visible: props.visible
    ...
    ctx.effect(() => sidebar.registerTab({
      ...
      component: (props) => {
        ...
        return (0, import_react6.createElement)(SplitDiffView, { seed, remote, t });
      }
    ...
    ctx.effect(() => sidebar.registerTab({
      ...
      component: (props) => {
        ...
        return (0, import_react6.createElement)(DiffView, {
          record,
