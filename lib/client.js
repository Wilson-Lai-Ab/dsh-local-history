...
function groupByRound(records, rounds, newestFirst) {
  ...
  for (const record of records) {
    ...
    const key = owned !== void 0 ? `r${owned.round}` : record.turn === void 0 ? "x" : `t${record.turn}`;
...
function DiffView(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh_lh_root dsh_lh_pane", "data-lh-diff": "", children: [
    ...
    state.binary ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh_lh_empty", children: t("binaryFile") }) : showPreview ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(PreviewBoundary, { fallback: t("loadFailed"), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh_lh_md", children: (0, import_react6.createElement)(import_dsh_client_ui_primitives.MarkdownText, {
      text: state.after,
